...
<select name="month" id="month">
  ...
  <option value="December">Dec</option>
     ...
     <tr>
    <td width="183"><div align="right"><span class="style1">*</span><span class="style3">Area/Town</span> </div></td>
    <td width="290"><div align="left"> <input type="text" name="town" id="town" size="30" onblur="f1()"/>
    <span class="textfieldValidState" id="fn"></span></div></td>
  </tr>
